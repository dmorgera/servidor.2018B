 ...
 * 
 * Publicado bajo Licencia de Proyecto Educativo Pr√°ctico 
 * <http://laurel.datsi.fi.upm.es/~ssoo/LICENCIA/LPEP> 
 * 
 * Queda prohibida la difusi√≥n total o parcial por cualquier 
 * medio del material entregado al alumno para la realizaci√≥n  
 * de este proyecto o de cualquier material derivado de este,  
 * incluyendo la soluci√≥n particular que desarrolle el alumno. 
 */ 
...
/* El cliente manda un mensaje QUIT al servidor, y espera su finalizaciÛn que
   vendr· corroborada por una respuesta OK. Toda esta comunicaciÛn es por
...
void recibir_fichero(int sock,int fich)
{
  ...
  while((tam=read(sock,(void*)buff,512))>0)
